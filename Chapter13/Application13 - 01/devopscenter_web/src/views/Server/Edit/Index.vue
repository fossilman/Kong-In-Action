  ...
  <div class="server-eidt">
    <div class="breadcrumb">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>服务器编辑</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="edit">
      <el-form ref="form" :model="form" label-width="80px">
        <el-form-item label="ip地址">
          <el-input v-model.trim="form.ip" style="max-width: 500px" :disabled="true"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button type="primary" @click="onSubmit" :loading="loading">立即编辑</el-button>
...
import { serversUpdate } from "@/server/servers.ts";
@Component
export default class ServerEdit extends Vue {
  ...
  private mounted(): void {
    ...
    this.form.team = this.$route.query.team;
  ...
  private onSubmit(): void {
    ...
    this.loading = true;
    serversUpdate(this.form.id, this.form.ip, this.form.name, this.form.remark, this.form.port, this.form.team).then((rs: any) => {
      this.loading = false;
